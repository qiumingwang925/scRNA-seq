...
| | |
|---|---|
| **Input** | `scNexus_test_data/Demo_Module_I_21401X3_Subset.rds`, or a Cell Ranger MEX folder `scNexus_test_data/Demo_Module_I_MEX_21401X3`  |
...
> 📷 **Screenshot:** ![Screenshot for uploading file](img/module-I/01-import-mex.png)_Import tab showing the two load options_ — `img/module-I/01-import-mex.png`
...
> 📷 **Screenshot:** ![Screenshot for uploading file](img/module-I/02-import-rds.png)_Import tab showing the two load options_ — `img/module-I/02-import-rds.png`
...
> 📷 **Screenshot:** _QC tab showing threshold sliders and pass/fail scatter_ — `img/module-I/03-qc.png`![Screenshot for uploading file](img/module-I/03-qc.png)
...
> 📷 **Screenshot:** _PCA tab with elbow plot after running PCA_ — `img/module-I/04-pca.png`![Screenshot for uploading file](img/module-I/04-pca.png)
...
> 📷 **Screenshot:** _Doublet tab UMAP colored by singlet/doublet_ — `img/module-I/05-doublet.png`![Screenshot for uploading file](img/module-I/05-doublet.png)
...
> 📷 **Screenshot:** _Cell Cycle tab UMAP colored by S and G2M phase scores_ — `img/module-I/06-cellcycle.png`![Screenshot for uploading file](img/module-I/06-cellcycle.png)
...
2. Optionally, **Upload Processed Seurat Object** if the dataset wasn't processed from beginning of the workflow.
...
> 📷 **Screenshot:** _Annotation tab with SingleR labels on the UMAP_ — `img/module-I/07-plotly.png`![Screenshot for uploading file](img/module-I/07-plotly.png)
...
> 📷 **Screenshot:** _Annotation tab with SingleR labels on the UMAP_ — `img/module-I/08-expression.png`![Screenshot for uploading file](img/module-I/08-expression.png)

> 📷 **Screenshot:** _Annotation tab with SingleR labels on the UMAP_ — `img/module-I/09-de.png`![Screenshot for uploading file](img/module-I/09-de.png)
...
> 📷 **Screenshot:** _Annotation tab with SingleR labels on the UMAP_ — `img/module-I/10-singler.png`![Screenshot for uploading file](img/module-I/10-singler.png)

> 📷 **Screenshot:** _Annotation tab with SingleR labels on the UMAP_ — `img/module-I/11-singler-vis.png`![Screenshot for uploading file](img/module-I/11-singler-vis.png)
...
> 📷 **Screenshot:** _Annotation tab with SingleR labels on the UMAP_ — `img/module-I/12-download.png`![Screenshot for uploading file](img/module-I/12-download.png)
